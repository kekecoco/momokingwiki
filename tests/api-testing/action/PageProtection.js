...
describe('Page protection', function () {
    ...
    describe('levels', function () {
        ...
        before(async () => {
            ...
            const addSysopProtection = await admin.action('protect', {
                title: protectedPage,
            ...
            const addSysopProtectionNonexisting = await admin.action('protect', {
            ...
            const addAutoConfirmedProtection = await admin.action('protect', {
