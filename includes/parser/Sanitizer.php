...
class Sanitizer
{
     ...
     *   This argument should be considered @param array|bool $args Arguments for the processing callback
     ...
     *      values before further cleanup; should be considered @return string The cleaned up HTML
     * @return-taint escaped
     * @internal
